Pod::Spec.new do |s|
  s.name         = "TriumphSDK"
  s.version      = "1.2.2"
  # s.version      = "1.2.2-UnityFix-32"
  # s.version      = "1.2.2-MAX-FIX-7"
  ...
  s.source       = { :http => 'https://cdn.triumpharcade.com/triumph-kit-releases/TriumphSDK-v1.2.2.zip' }
  # s.source       = { :http => 'https://cdn.triumpharcade.com/triumph-kit-releases/TriumphSDK-UnityFix-32.zip' }
  # s.source       = { :http => 'https://cdn.triumpharcade.com/triumph-kit-releases/TriumphSDK-FIX-v1.2.7.zip' }
